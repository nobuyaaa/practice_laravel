            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\ShiftController@create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type = "number"class="form-control" name="starttime" rows="2" value={{ old('starttime') }}>
                        </div>
                    </div>
                         <div class="form-group row">
                        <label class="col-md-2">終わる時間</label>
                        <div class="col-md-10">
                            <input type="number" class="form-control" name="endtime" rows="2" value={{ old('endtime') }}>
                        </div>
                        </div>
                    </div>
                    {{ csrf_field() }}
